...
{
	public partial class tbl_scheduleService
	{
   		     
		/// <summary>
        /// 数据库操作对象
        /// </summary>
        private tbl_scheduleDAO _dao = new tbl_scheduleDAO();
        ...
        {
            return _dao.Delete(id_tbl_schedule);
        }
        #endregion
        ...
        {
            return _dao.Update2(id_tbl_schedule, col_remainticket);
        }
        ...
        {
            return _dao.QuerySingle(id_tbl_schedule);
        }
        #endregion
