...
{
    public partial class tbl_TicketService
    {

        /// <summary>
        /// 数据库操作对象
        /// </summary>
        private tbl_TicketDAO _dao = new tbl_TicketDAO();
        ...
        {
            return _dao.Delete(id_tbl_ticket);
        }
        #endregion
        ...
        {
            return _dao.QuerySingle(id_tbl_ticket);
        }
        #endregion
